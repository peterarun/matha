...
public class AutoCompletionTextField extends TextField {
    ...
    public AutoCompletionTextField() {
       ...
       // this.entries.addAll(Arrays.asList(new String[]{"Hey", "Hello", "Hello World", "Apple", "Cool", "Costa", "Cola", "Coca Cola"}));
    ...
    public void setListner() {     
        ...
        textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (enteredText == null || enteredText.isEmpty()) {
                ...
                System.out.println(entriesPopup.isShowing());
